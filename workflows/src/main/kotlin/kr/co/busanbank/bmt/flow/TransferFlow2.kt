...
//                    //								BigInteger.ZERO.compareTo(fromToken.getAmount()) < 0);
//                    null
//            try {
...
//            val equalAssetExpress = net.corda.core.node.services.vault.Builder
//                    .equal<String>(assetNumberField!!, assetNumber)
//            val equalAsset = VaultCustomQueryCriteria(equalAssetExpress)
//
//            val equalAddressExpress = net.corda.core.node.services.vault.Builder
//                    .equal<String>(ownerField!!, address)
//            val equalAddress = VaultCustomQueryCriteria(equalAddressExpress)
//
//            val query = unconsumed.and(equalAsset).and(equalAddress)
//            var fromStateReference: StateAndRef<AssetTokenState>? = null
//
//            var moveAmount = BigInteger(amount)
//
//            try {
//                val pages = serviceHub.vaultService
//                        .queryBy(AssetTokenState::class.java, query).states
//
//                if (pages.size > 0) {
//                    fromStateReference = pages[0]
//                    val fromAmount = fromStateReference!!.state.data.amount
//                    moveAmount = moveAmount.add(fromAmount)
//                }
//
//            } catch (e: Exception) {
//                //				e.printStackTrace();
//            }
//
//            val fromAsset = AssetTokenState(participantList, assetNumber, address, moveAmount.toLong(),
//                    UniqueIdentifier())
//
...
//
//            if (fromStateReference != null) {
//                txBuilder.addInputState(fromStateReference)
//            }
//
...
//                        require.using("This must be an DigitalAssetState transaction.",
//                                state1 is AssetTokenState)
